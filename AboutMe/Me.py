...
# Page configuration
st.set_page_config(page_title="Jingwen Zhang - Home", page_icon="📄", layout="centered")

# Title and subtitle
st.title("Jingwen Zhang")
st.markdown("#### Pronouns: She/Her")
st.markdown("#### Berkeley, CA")
...
> Appreciate that you would take some time in exploring me :)
...
# Navigation note
# st.markdown("Navigate through the sidebar to learn more about my Projects, Tech Stack, Education, Personal Values, and Contact.");
